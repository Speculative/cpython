...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_SWAP_FAST_0] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_1] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_2] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_3] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_4] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_5] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_6] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST_7] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_SWAP_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_STORE_ATTR_INSTANCE_VALUE] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ESCAPES_FLAG,
    [_LOCK_OBJECT] = HAS_DEOPT_FLAG,
    [_STORE_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_ATTR_SLOT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_PUSH_EXC_INFO] = HAS_ESCAPES_FLAG,
    ...
    [_CALL_LIST_APPEND] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
